...
, span.questionshowtooltipclosebutton 
{
	cursor: pointer;
...
, span.questionshowtooltipclosebutton:hover 
{
...
add_action('the_content','tooltipsInContent',20000);
add_action('wp_head', 'tooltipsHead');
add_action('the_content','showTooltips',20000);
...
{
	add_action('the_excerpt','tooltipsInContent',20000);
	add_action('the_excerpt','showTooltips',20000);	
}
...
function upgrade_check()
{
	...
	update_option('ztooltipversion','5.3.7');
}
...
<li>
*  Support tooltips for <a href="https://tooltips.org/product/show-tooltips-in-woocommerce-products/">WooCommerce Product</a>, <a href="https://tooltips.org/add-tooltips-for-table/">Tables</a>, <a href="https://tooltips.org/tooltips-for-pricing-table/" >Pricing Table</a>, <a href="https://tooltips.org/tooltips-for-button/">Buttons</a>, Contact Form 7, BuddyPress, bbPress, ACF, HTML5 FAQ, menu item, posts title, tags...more
</li>
<li>
